...
A vector space $V$ can be written as a sum of subspaces $W_1$, $W_2$ - written as $V = W_1 + W_2$ - if every vector in ${\bf v}\in V$ can be written as ${\bf v} = {\bf w}_1 + {\bf w}_2$ with ${\bf w}_i\in W_i$ (another way to express this is to say $V = Span\{W_1, W_2\}$). The vector space $V$ can be written as a {\it direct sum} of two subspaces $W_1, W_2$ if
\begin{itemize}
\item $V = W_1 + W_2$;
