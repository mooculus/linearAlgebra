...
\begin{itemize}
\item For $\lambda = -6$, E_{-6}(A) = N(A + 6Id) = N\left(\begin{bmatrix} 8 & 2\\4 & 1\end{bmatrix}\right)$. Then $E_{-6}(A) = N(A + 6Id) = Span\{\begin{bmatrix} -1\\4\end{bmatrix}\}$.
\item For $\lambda = 3$, E_{3}(A) = N(A - 3Id) = N\left(\begin{bmatrix} -1 & 2\\4 & -8\end{bmatrix}\right)$. Then $E_{3}(A) = N(A - 3Id) = Span\{\begin{bmatrix} 2\\1\end{bmatrix}\}$.
\end{itemize}
