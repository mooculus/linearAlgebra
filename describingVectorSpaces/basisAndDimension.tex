...
In the event the vector space $W$ is not naturally a subspace of $\mathbb R^n$ for some $n$ this algorithm still applies, but we need to do something else first. That is described in the next section.
