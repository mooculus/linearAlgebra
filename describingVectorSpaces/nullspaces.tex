...
\]
Using MATLAB or Octave, compute $rref(A)$ (hint: do this in rational format by entering the command "format rat" before executing the rref command). Then use the resulting output to spanning set for $N(A)$. See if you can find a spanning set consisting of vectors with integer entries.
\end{exercise}
