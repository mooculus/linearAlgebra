...
It is natural to ask: what does it mean for a map to be a linear transformation? For example, if $f:\mathbb R\to \mathbb R$, or more generally if $f:\mathbb R^n\to \mathbb R^m$ satisfies the above property, does it admit some simple description? We investigate this question next.
\vskip.3in
