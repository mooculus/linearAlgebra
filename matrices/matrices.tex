...
\begin{definition} When working with a fixed system of numbers such as $\mathbb R$ (real numbers) or $\mathbb C$ (complex numbers), the elements of that number system in linear algebra are oftern referred to as \dfn{scalars}.
\end{definition}
