...
\begin{proposition} The original system of equations given in (2) has an ACM given as the concatenated matrix $[A\ b]$, where $A$ and $b$ are as in (0.6), the matrix equation corresponding to (2).
\end{proposition}
